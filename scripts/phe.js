...
import {
   ...
   , ONE_PAIR
   , HIGH_CARD
} from './lib/hand-rank.js'

export {handRank, rankDescription}
...
import {evaluate_5_cards as evaluate5cards} from './lib/evaluator5.js'
import {evaluate_6_cards as evaluate6cards} from './lib/evaluator6.js'
import {evaluate_7_cards as evaluate7cards} from './lib/evaluator7.js'
 ...
 */
export function evaluateCardCodes(codes) {
 ...
 * performant.
 */
export function evaluateCardsFast(cards) {
 ...
 * performant.
 */
export function rankCardsFast(cards) {
